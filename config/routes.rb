  ...
  resources :projects do
    ...
    resources :test_plans do
      ...
      member do
        ...
        post 'reorder', to: 'test_plans#reorder'
        post 'copy', to: 'test_plans#copy'
      end

      # Quick per-case status update from the plan dashboard.
      post 'test_plan_cases/:test_plan_case_id/status', to: 'test_case_executions#update_status'
